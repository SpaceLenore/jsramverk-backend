...
(4, "Test & CI", "Use-case 1: En användare ska kunna navigera mellan olika sidor med hjälp av länkar i navbar. use-case 2: Vid felaktig inloggning så visas ett felmeddelande. Use-case 3: Användaren måste godkänna att vi lagrar deras data när de registrerar sig på sidan.");
